...
// The 8080 flags are Z, S, P, CY, and AC
// Z: Zero flag, set to 1 when result is 0
// S: sign flag set to 1 when bit 7 is set
// P: parity flag set when answer has even parity clear when odd
// CY: carry flag set to 1 when the instruction resulted in carry out or 
//      borrow into the high order bit
// AC: auxillary carry used mostly for binary coded decimal math. Not used
//      by space invaders
